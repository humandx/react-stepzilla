  ...
  _createClass(StepZilla, [{
    ...
    value: function setNavState(next) {
      ...
      if (next < this.props.steps.length) {
        ...
        var visitedStates = this.state.visitedStates;
    ...
    value: function jumpToStep(evt) {
      ...
      if (typeof evt.target === 'undefined') {
        ...
        this.abstractStepMoveAllowedToPromise(evt.target.value, movingBack).then(function () {
    ...
    key: "stepMoveAllowed",
    value: function stepMoveAllowed(futureStep) {
      var skipValidationExecution = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var proceed = false;
    ...
    value: function abstractStepMoveAllowedToPromise(futureStep, movingBack) {
      return _promise["default"].resolve(this.stepMoveAllowed(futureStep, movingBack));
    ...
    value: function renderSteps() {
      ...
      return this.props.steps.map(function (s, i) {
        var divClassName = 'pointer';

        if (i === 0) {
          divClassName += ' first';
        } else if (i === _this5.props.steps.length - 1) {
          divClassName += ' last';
        }
        ...
        }, _react["default"].createElement("em", null, i + 1), _react["default"].createElement("span", {
          className: "stepName"
